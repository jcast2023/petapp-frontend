...
@Component({
  ...
  styleUrl: './crear-vacuna.component.scss'
})
export class CrearVacunaComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    console.log('📤 Creando vacuna:', datos);

    this.vacunaService.crear({
    ...
    .subscribe({
      ...
      error: (error: HttpErrorResponse) => {
        ...
        this.error.set(error.error?.mensaje || 'Error al crear el registro de vacuna');
      }
    });
  }
}
